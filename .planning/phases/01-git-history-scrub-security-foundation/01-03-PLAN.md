  ...
  <action>
    ...
    **Job 1: Working tree PII scan (custom grep)**
    ...
    - Grep all tracked files for specific known PII patterns:
      `{account_id}|Z0[0-9]{7,}|{llc_name}|{llc_short}|{spreadsheet_id}|admin@kamdental|admin@unifiedental|9424526a[a-f0-9]{56}`
    ...
    **File 2: `scripts/qa/pii-audit.sh`**
    ...
    SPECIFIC_PATTERNS="{account_id}|Z0[0-9]{7,}|{llc_name}|{llc_short}|{spreadsheet_id}|admin@kamdental|admin@unifiedental|9424526a[a-f0-9]{56}"
