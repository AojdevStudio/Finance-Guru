...
<objective>
Create the six shared Pydantic models that all four hedging CLI tools (Phases 7-9) will import.
...
<output>
After completion, create `.planning/phases/06-config-loader-shared-hedging-models/06-01-SUMMARY.md`
</output>
