...
Purpose: This is the DRY bridge that prevents each CLI from duplicating YAML parsing and override logic. It also creates the data directory that Phase 7 (rolling tracker, hedge sizer) will read from and write to.
...
<output>
After completion, create `.planning/phases/05-config-loader-shared-hedging-models/05-02-SUMMARY.md`
</output>
