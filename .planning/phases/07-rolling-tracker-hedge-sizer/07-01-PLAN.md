...
# Phase 5 deliverables (what we consume)
...
- All methods use Phase 5 models (HedgePosition, RollSuggestion) and config (HedgeConfig)
...
<output>
After completion, create `.planning/phases/07-rolling-tracker-hedge-sizer/07-01-SUMMARY.md`
</output>
