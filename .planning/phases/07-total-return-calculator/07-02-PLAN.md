...
Purpose: The CLI is how users and agents invoke the total return calculator. The tests ensure calculations are correct with deterministic synthetic data. Together they complete the Phase 7 deliverable: a working `total_return_cli.py` that meets all five success criteria.
...
<verification>
Run the complete Phase 7 verification:
