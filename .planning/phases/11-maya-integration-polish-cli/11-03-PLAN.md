...
must_haves:
  truths:
    - "All 3 explorers are rebuilt with the Export Profile button from Plan 11-01"
...
<objective>
Rebuild all explorers with Phase 11 enhancements, run all tests, and verify the complete integration chain: explorer -> export -> Maya reads profile, and CLI -> browser.

Purpose: End-to-end verification that Phase 11 delivers on all 4 success criteria. This is the final phase on feat/m3-explorer -- everything must work before the merge PR.
...
@.planning/ROADMAP.md
@.planning/STATE.md
@.planning/phases/11-maya-integration-polish-cli/11-01-SUMMARY.md
@.planning/phases/11-maya-integration-polish-cli/11-02-SUMMARY.md

Plan 11-01 SUMMARY provides: Explorer template enhanced with Export Profile button + Maya agent updated
Plan 11-02 SUMMARY provides: Landing page created + CLI explore subcommand added + tests written
</context>
...
<task type="auto">
  ...
  <action>
Rebuild all 3 knowledge explorers using the enhanced template from Plan 11-01, then run the full verification suite.
...
**Step 4: Verify Phase 10 features still present (no regression):**
...
- Phase 10 features preserved (localStorage, learning modes, clipboard, responsive)
...
<task type="checkpoint:human-verify" gate="blocking">
  <what-built>
Complete Phase 11 integration: Maya learner profile export, topic selector landing page, CLI launcher, and Maya agent updates.
...
6. **Phase 11 success criteria check:**
  ...
  <resume-signal>Type "approved" if all Phase 11 features work correctly, or describe any issues found.</resume-signal>
</task>
...
<success_criteria>
- All 4 Phase 11 success criteria from ROADMAP.md are satisfied
- All explorers rebuilt with Export Profile feature
- Python tests pass
- Human verifies export, landing page, CLI, and Maya integration
- Phase 11 is the final phase on feat/m3-explorer -- ready for merge PR to main
</success_criteria>

<output>
After completion, create `.planning/phases/11-maya-integration-polish-cli/11-03-SUMMARY.md`
</output>
