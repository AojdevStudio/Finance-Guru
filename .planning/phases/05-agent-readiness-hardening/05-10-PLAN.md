...
Purpose: Success criterion 4 of Phase 5 -- enforce minimum 80% coverage on src/. This is the capstone plan that locks in the coverage gains from Plans 05-09.
...
<output>
After completion, create `.planning/phases/05-agent-readiness-hardening/05-10-SUMMARY.md`
</output>
