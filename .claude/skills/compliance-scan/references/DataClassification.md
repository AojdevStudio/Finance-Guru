...
| Instead of | Write |
| --- | --- |
| `equity of $188,859 understated the real $204,753` | `as-synced equity understated the real figure by 8%` |
| `a real $10,991 reported as $31,304` | `inflated the review roughly 3x` |
| `the true figure was $13,500` | `the true figure was 70% higher` |
| `$1,346 across 30 payments` | `30 payments, about 86% of the closed month` |
| `DIRECT DEPOSIT APEX SYSTEMSDIR DEP` | `DIRECT DEPOSIT ACME STAFFINGDIR DEP` |
...
and carries cents. `$50,000` is a scenario. `$204,753` and `$7,936.23` are
statements about a real household.
