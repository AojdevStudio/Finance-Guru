...
# MEANS, not because it matches a string, which is why $204,753 of account equity
# passed a clean scan on 2026-08-31 and reached a public PR.
#
...
# ($204,753) or carries cents ($7,936.23). Flag the precise ones and let the
# allowlist carry genuine public reference data such as IRS bracket edges.
