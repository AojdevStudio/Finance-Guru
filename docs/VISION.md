...
- Defined in YAML (portable, not the current Markdown persona files)
...
| **Persona definitions in `.claude/commands/`** | Agents move to YAML. Portable, simple, not framework-dependent. |
