...
class TestNamedConstants:
    ...
    def test_default_risk_free_rate_consistent_across_modules(self, doc_text):
        ...
        assert RT_RFR == 0.045, "rolling_tracker.DEFAULT_RISK_FREE_RATE drifted from 0.045"
        assert OCC_RFR == 0.045, "options_chain_cli.DEFAULT_RISK_FREE_RATE drifted from 0.045"
